(() => {
  ...
  function I(t2) {
    ...
    var e2 = t2.g;
    return null ==
      (e2 = null == e2 || x(e2) ? e2 : "string" == typeof e2 ? S(e2) : null)
      ? e2
      : (t2.g = e2);
  }
  var F = class {
  ...
  function ht(t2, e2) {
    if (null != t2) {
      if ("string" == typeof t2) t2 = t2 ? new F(t2, L) : R();
        ...
        if (x(t2)) t2 = t2.length ? new F(new Uint8Array(t2), L) : R();
        else {
          if (!e2) throw Error();
          t2 = void 0;
        }
  ...
  var wt = gt((t2) =>
    vt ? t2 >= At && t2 <= kt : "-" === t2[0] ? St(t2, Tt) : St(t2, bt),
  );
  ...
  function Bt(t2, e2) {
    if (2147483648 & e2)
      if (D()) t2 = "" + ((BigInt(0 | e2) << BigInt(32)) | BigInt(t2 >>> 0));
      else {
  ...
  function Gt(t2) {
    if (t2.length < 16) Mt(Number(t2));
      ...
      ((t2 = BigInt(t2)),
        (Rt = Number(t2 & BigInt(4294967295)) >>> 0),
        (It = Number((t2 >> BigInt(32)) & BigInt(4294967295))));
    else {
      const e2 = +("-" === t2[0]);
      It = Rt = 0;
      const n2 = t2.length;
  ...
  function ie(t2) {
    if (((t2 = Kt(t2)), !Wt(t2))) {
      ...
      ((t2 = 2147483648 & n2) &&
        ((n2 = ~n2 >>> 0),
        0 == (e2 = (1 + ~e2) >>> 0) && (n2 = (n2 + 1) >>> 0)),
        (t2 =
          "number" == typeof (e2 = Ct(e2, n2))
            ? t2
              ? -e2
              : e2
            : t2
  ...
  function se(t2) {
    ...
    return Wt(e2)
      ? String(e2)
      : (-1 !== (e2 = t2.indexOf(".")) && (t2 = t2.substring(0, e2)), re(t2));
  }
  function oe(t2) {
    var e2 = Kt(Number(t2));
    return Wt(e2)
  ...
  function ae(t2) {
    return (
      Wt(t2)
        ? (t2 = Et(ie(t2)))
        : ((t2 = Kt(t2)),
          Wt(t2) ? (t2 = String(t2)) : (Mt(t2), (t2 = Bt(Rt, It))),
          (t2 = Et(t2))),
      t2
    );
  }
  ...
  function fe(t2, e2, n2, r2) {
    return null != t2 && t2[q] === ot
      ? t2
      : Array.isArray(t2)
        ? ((r2 = (n2 = 0 | t2[Q]) | (32 & r2) | (2 & r2)) !== n2 && rt(t2, r2),
          new e2(t2))
        : (n2
            ? 2 & r2
              ? ((t2 = e2[V]) || (it((t2 = new e2()).v), (t2 = e2[V] = t2)),
                (e2 = t2))
              : (e2 = new e2())
            : (e2 = void 0),
          e2);
  ...
  function Me(t2) {
    switch (typeof t2) {
      ...
      case "object":
        ...
        return t2 instanceof Ee
          ? (t2 = 0 !== t2.size ? t2.V(Fe) : void 0)
          : void 0;
    }
    return t2;
  }
  ...
  function Be(t2, e2, n2) {
    return (
      2 & e2 ||
        (!n2 || 4096 & e2 || 16 & e2
          ? (t2 = Ve(t2, e2, false, n2 && !(16 & e2)))
          : (nt(t2, 34), 4 & e2 && Object.freeze(t2))),
      t2
    );
  }
  ...
  function Xe(t2) {
    ...
    return at(t2, n2)
      ? Ke(t2, e2, n2)
        ? Ge(t2, e2, true)
        : new t2.constructor(Ve(e2, n2, false))
      : t2;
  }
  function He(t2) {
  ...
  function ze(t2, e2) {
    (void 0 === e2 && (e2 = 0 | t2[Q]),
      32 & e2 && !(4096 & e2) && rt(t2, 4096 | e2));
  }
  function Ke(t2, e2, n2) {
    return (
      !!(2 & n2) ||
      (!(!(32 & n2) || 4096 & n2) && (rt(e2, 2 | n2), (t2.h = ct), true))
    );
  }
  var Ye = Et(0);
  var qe = {};
  ...
  function Qe(t2, e2, n2, r2, i2) {
    ...
    return s2 <= o2
      ? ((t2[s2] = r2), e2)
      : (void 0 !== r2 &&
          (n2 >= (o2 = ((e2 ?? (e2 = 0 | t2[Q])) >> 14) & 1023 || 536870912)
  ...
  function en(t2, e2, n2, r2, i2) {
    ...
    ((r2 = at(t2, o2) ? 1 : r2),
      (i2 = !!i2 || 3 === r2),
      2 === r2 && He(t2) && ((s2 = t2.v), (o2 = 0 | s2[Q])));
    let a2 = (t2 = rn(s2, e2)) === tt ? 7 : 0 | t2[Q],
      c2 = sn(a2, o2);
    var h2 = !(4 & c2);
    if (h2) {
      4 & c2 &&
        ((t2 = Vt(t2)), (a2 = 0), (c2 = An(c2, o2)), (o2 = Qe(s2, o2, e2, t2)));
      let r3 = 0,
        i3 = 0;
      for (; r3 < t2.length; r3++) {
        const e3 = n2(t2[r3]);
    ...
    return (
      c2 !== a2 && (rt(t2, c2), 2 & c2 && Object.freeze(t2)),
      nn(t2, c2, s2, o2, e2, r2, h2, i2)
    );
  }
    ...
    return (
      1 === s2 || (4 === s2 && (2 & e2 || (!(16 & e2) && 32 & r2)))
        ...
        : (2 === s2 &&
            ...
            (e2 = An(e2, r2)),
            (r2 = Qe(n2, r2, i2, t2))),
          on(e2) || (a2 || (e2 |= 16), e2 !== c2 && rt(t2, e2))),
      2 & e2 || !(4096 & e2 || 16 & e2) || ze(n2, r2),
      t2
    );
  }
  ...
  function dn(t2, e2, n2, r2, i2) {
    const s2 = fn(t2),
      o2 = pn(s2, t2, e2, n2, i2);
    return (
      o2 !== r2 && (o2 && (e2 = Qe(t2, e2, o2, void 0, i2)), s2.set(n2, r2)),
      e2
    );
  }
  function pn(t2, e2, n2, r2, i2) {
    ...
    for (let t3 = 0; t3 < r2.length; t3++) {
      const o2 = r2[t3];
      null != Je(e2, o2, i2) &&
        (0 !== s2 && (n2 = Qe(e2, n2, s2, void 0, i2)), (s2 = o2));
    }
  ...
  function yn(t2, e2, n2, r2) {
    ...
    if (((s2 = 0 | i2[Q]), !at(t2, s2))) {
      const o2 = Xe(e2);
      o2 !== e2 &&
        (He(t2) && ((i2 = t2.v), (s2 = 0 | i2[Q])),
        (s2 = Qe(i2, s2, n2, (e2 = o2), r2)),
        ze(i2, s2));
    }
    return e2;
  }
  function _n(t2, e2, n2, r2, i2, s2, o2, a2) {
    ...
    ((s2 = c2 ? 1 : s2),
      (o2 = !!o2 || 3 === s2),
      (c2 = a2 && !c2),
      (2 === s2 || c2) && He(t2) && (n2 = 0 | (e2 = t2.v)[Q]));
    var h2 = (t2 = rn(e2, i2)) === tt ? 7 : 0 | t2[Q],
      u2 = sn(h2, n2);
    if ((a2 = !(4 & u2))) {
      var l2 = t2,
        f2 = n2;
    ...
    if (
      (u2 !== h2 && (rt(t2, u2), 2 & u2 && Object.freeze(t2)),
      c2 &&
        !(
          8 & u2 ||
          (!t2.length &&
      ...
      for (
        on(u2) && ((t2 = Vt(t2)), (u2 = An(u2, n2)), (n2 = Qe(e2, n2, i2, t2))),
          r2 = t2,
          c2 = u2,
          h2 = 0;
        h2 < r2.length;
  ...
  function bn(t2, e2, n2, r2) {
    var i2 = r2;
    (We(t2),
      (t2 = _n(t2, (r2 = t2.v), 0 | r2[Q], n2, e2, 2, true)),
      (i2 = null != i2 ? i2 : new n2()),
      t2.push(i2),
      (e2 = n2 = t2 === tt ? 7 : 0 | t2[Q]),
      (i2 = at(i2))
  ...
  function In(t2, e2, n2) {
    {
      ...
      if (null == n2) Qe(o2, a2, e2);
        ...
        var r2 = (t2 = n2 === tt ? 7 : 0 | n2[Q]),
          i2 = on(t2),
          s2 = i2 || Object.isFrozen(n2);
        for (
          i2 || (t2 = 0),
            s2 || ((n2 = Vt(n2)), (r2 = 0), (t2 = An(t2, a2)), (s2 = false)),
            t2 |= 5,
            t2 |=
        ...
        (t2 !== r2 && (s2 && ((n2 = Vt(n2)), (t2 = An(t2, a2))), rt(n2, t2)),
          Qe(o2, a2, e2, n2));
      }
    }
  }
  ...
  function xr(t2, e2, n2) {
    var r2 = t2.v;
    (H && H in r2 && (r2 = r2[H]) && delete r2[e2.g],
  ...
  var Lr = class {
    ...
    j() {
      var t2 = xo,
        ...
        r2 = H;
      if (
        (B && r2 && null != e2[r2]?.[n2] && U(W, 3),
        (e2 = t2.g),
        $ && H && void 0 === $ && (r2 = (n2 = this.v)[H]) && (r2 = r2.da))
      )
        try {
          r2(n2, e2, Le);
        } catch (t3) {
    ...
    clone() {
      const t2 = this.v,
        e2 = 0 | t2[Q];
      return Ke(this, t2, e2)
        ? Ge(this, t2, true)
        : new this.constructor(Ve(t2, e2, false));
    }
  };
  ((Lr.prototype[q] = ot),
  ...
  function $r(t2, e2, n2, r2) {
    ...
    const o2 = n2.h;
    t2[e2] = (t3, e3, n3) =>
      o2(t3, e3, n3, s2 || (s2 = jr(Cr, qr, $r, r2).T), i2 || (i2 = Jr(r2)));
  }
  function Jr(t2) {
    let e2 = t2[Ur];
    if (!e2) {
  ...
  var ii = Ir(
    function (t2, e2, n2, r2, i2) {
      ...
      if (
        ((t2 = Vt((t2 = Yn(t2, Ne([void 0, void 0], r2), i2)))),
        (i2 = pt((r2 = 0 | e2[Q]))),
        2 & r2)
      )
        throw Error();
      ...
      if (s2 instanceof Ee)
        0 != (2 & s2.J)
          ? ((s2 = s2.V()), s2.push(t2), Qe(e2, r2, n2, s2, i2))
          : s2.Ma(t2);
      else if (Array.isArray(s2)) {
        var o2 = 0 | s2[Q];
        (8192 & o2 || rt(s2, (o2 |= 8192)),
          2 & o2 && ((s2 = cn(s2)), Qe(e2, r2, n2, s2, i2)),
          s2.push(t2));
  ...
  function li(t2, e2, n2) {
    null !=
      (e2 =
        null == e2 || "string" == typeof e2 || e2 instanceof F ? e2 : void 0) &&
      pr(t2, n2, Pn(e2, true).buffer);
  }
  ...
  function di(t2, e2, n2) {
    return (
      (5 === t2.h || 2 === t2.h) &&
      ((e2 = un(e2, 0 | e2[Q], n2)),
      2 == t2.h ? Jn(t2, Dn, e2) : e2.push(Dn(t2.g)),
      true)
    );
  }
  var pi = ei(
  ...
  var yi = ei(
    function (t2, e2, n2) {
      return (
        5 === t2.h && (ri(e2, n2, 0 === (t2 = Dn(t2.g)) ? void 0 : t2), true)
      );
    },
    si,
    br,
  ...
  var _i = ei(
    function (t2, e2, n2) {
      return (
        0 !== t2.h ? (t2 = false) : (ri(e2, n2, Cn(t2.g, Nt)), (t2 = true)),
        t2
      );
    },
    oi,
  ...
  var vi = ei(
    function (t2, e2, n2) {
      return (
        0 !== t2.h
          ? (e2 = false)
          : (ri(e2, n2, (t2 = Cn(t2.g, Nt)) === Qr ? void 0 : t2), (e2 = true)),
        e2
      );
    },
    oi,
  ...
  var Ei = ei(
    function (t2, e2, n2) {
      return (
        0 !== t2.h ? (t2 = false) : (ri(e2, n2, Cn(t2.g, Ot)), (t2 = true)),
        t2
      );
    },
    function (t2, e2, n2) {
      if (
        ((e2 = (function (t3) {
          ...
          if (te(t3)) {
            ...
            if ("number" === e3)
              return (
                ((t3 = Kt(t3)) >= 0 && Wt(t3)) || (Mt(t3), (t3 = Ct(Rt, It))),
                t3
              );
          }
        })(e2)),
  ...
  var Ti = ni(
    function (t2, e2, n2) {
      return (
        (0 === t2.h || 2 === t2.h) &&
        ((e2 = un(e2, 0 | e2[Q], n2)),
        2 == t2.h ? Jn(t2, Nn, e2) : e2.push(Nn(t2.g)),
        true)
      );
    },
    function (t2, e2, n2) {
  ...
  var Ai = ei(
    function (t2, e2, n2) {
      return (
        0 === t2.h && (ri(e2, n2, 0 === (t2 = Nn(t2.g)) ? void 0 : t2), true)
      );
    },
    ai,
    Er,
  ...
  var ki = ei(
    function (t2, e2, n2) {
      return (
        0 === t2.h &&
        (ri(e2, n2, false === (t2 = On(t2.g)) ? void 0 : t2), true)
      );
    },
    ci,
    _r,
  ...
  var Si = ni(
    function (t2, e2, n2) {
      return (
        2 === t2.h && ((t2 = qn(t2)), un(e2, 0 | e2[Q], n2).push(t2), true)
      );
    },
    function (t2, e2, n2) {
      if (null != (e2 = ti(le, e2)))
  ...
  var xi = ei(
    function (t2, e2, n2) {
      return (
        2 === t2.h && (ri(e2, n2, "" === (t2 = qn(t2)) ? void 0 : t2), true)
      );
    },
    hi,
    vr,
  ...
  var Ii = Ir(function (t2, e2, n2, r2, i2, s2) {
    ...
    let o2 = 0 | e2[Q];
    return (
      dn(e2, o2, s2, n2, pt(o2)),
      Yn(t2, (e2 = gn(e2, r2, n2)), i2),
      true
    );
  }, ui);
  var Fi = ei(
  ...
  var Mi = ni(
    function (t2, e2, n2) {
      return (
        (0 === t2.h || 2 === t2.h) &&
        ((e2 = un(e2, 0 | e2[Q], n2)),
        2 == t2.h ? Jn(t2, Un, e2) : e2.push(Un(t2.g)),
        true)
      );
    },
    function (t2, e2, n2) {
  ...
  var Pi = ei(
    function (t2, e2, n2) {
      return (
        0 === t2.h && (ri(e2, n2, 0 === (t2 = Un(t2.g)) ? void 0 : t2), true)
      );
    },
    fi,
    wr,
  ...
  var Ci = ei(
    ...
    function (t2, e2, n2) {
      null != (e2 = ee(e2)) &&
        ((e2 = parseInt(e2, 10)), lr(t2, n2, 0), cr(t2.g, e2));
    },
    Sr,
  );
  var Oi = class {
  ...
  var Gi = [
    ...
    ei(
      function (t2, e2, n2) {
        return (
          2 === t2.h && (ri(e2, n2, (t2 = $n(t2)) === R() ? void 0 : t2), true)
        );
      },
      function (t2, e2, n2) {
        if (null != e2) {
          if (e2 instanceof Lr) {
            const r2 = e2.Ra;
            return void (r2
              ? ((e2 = r2(e2)), null != e2 && pr(t2, n2, Pn(e2, true).buffer))
              : U(K, 3));
          }
  ...
  function Xi(t2) {
    ...
    return (
      ...
      (t2 = (e2 = ji) ? e2.createScriptURL(t2) : t2),
      new (class {
        constructor(t3) {
          this.g = t3;
        }
    ...
    ni(
      function (t2, e2, n2) {
        return (
          (0 === t2.h || 2 === t2.h) &&
          ((e2 = un(e2, 0 | e2[Q], n2)),
          2 == t2.h ? Jn(t2, Bn, e2) : e2.push(Nn(t2.g)),
          true)
        );
      },
      function (t2, e2, n2) {
  ...
  var Ws = [
    ...
    Hs,
    bi,
    [0, js, Ii, Zi, Ii, Ki, Ii, Wi, Ii, Ji, Ii, qi, Ii, Yi],
    Ci,
  ];
      ...
      g() {
        ...
        return (
          ...
          (e2 = (function (t3, e3, n3, r2) {
            ...
            return (
              !t3 && 32 & n3 && nt(s2, 32),
              (n3 = Qe(e3, n3, 2, (r2 = new Ee(s2, i2, de, void 0)))),
              t3 || ze(e3, n3),
              r2
            );
          })(this, e2, n2, t2)),
  ...
  function Bo(t2, e2) {
    return (
      (e2 = e2 ? e2.clone() : new Ns()),
      void 0 !== t2.displayNamesLocale
        ? Ze(e2, 1, ue(t2.displayNamesLocale))
        : void 0 === t2.displayNamesLocale && Ze(e2, 1),
      void 0 !== t2.maxResults
        ? xn(e2, 2, t2.maxResults)
        : "maxResults" in t2 && Ze(e2, 2),
      void 0 !== t2.scoreThreshold
        ? Ln(e2, 3, t2.scoreThreshold)
        : "scoreThreshold" in t2 && Ze(e2, 3),
      void 0 !== t2.categoryAllowlist
        ? In(e2, 4, t2.categoryAllowlist)
        : "categoryAllowlist" in t2 && Ze(e2, 4),
      void 0 !== t2.categoryDenylist
        ? In(e2, 5, t2.categoryDenylist)
        : "categoryDenylist" in t2 && Ze(e2, 5),
      e2
    );
  }
  function Go(t2) {
  ...
  function jo(t2, e2 = -1, n2 = "") {
    return {
      categories: t2.map((t3) => ({
        index: kn(t3, 1) ?? 0 ?? -1,
        score: Sn(t3, 2) ?? 0,
        categoryName: le($e(t3, 3)) ?? "" ?? "",
        displayName: le($e(t3, 4)) ?? "" ?? "",
      })),
      headIndex: e2,
      headName: n2,
    };
  ...
  function Vo(t2) {
    const e2 = {
      classifications: vn(t2, Rs, 1).map((t3) =>
        jo(yn(t3, gs, 4)?.g() ?? [], kn(t3, 2) ?? 0, le($e(t3, 3)) ?? ""),
      ),
    };
    return (
      null !=
            ...
            : "bigint" == typeof t3
              ...
              : te(t3)
                ? "number" == typeof t3
                  ...
                  : se(t3)
                : void 0;
        })($e(t2, 2, void 0, void 0, ce)) &&
        (e2.timestampMs = Go($e(t2, 2, void 0, void 0, ce) ?? Ye)),
      e2
    );
  }
  function Xo(t2) {
    ...
    if (
      ((e2 = yn(t2, Es, 4)?.l()) &&
        (s2.boundingBox = {
          originX: kn(e2, 1, qe) ?? 0,
          originY: kn(e2, 2, qe) ?? 0,
          width: kn(e2, 3, qe) ?? 0,
          height: kn(e2, 4, qe) ?? 0,
          angle: 0,
        }),
      ...
      for (const e3 of yn(t2, Es, 4).g())
        s2.keypoints.push({
          x: $e(e3, 1, void 0, qe, $t) ?? 0,
          y: $e(e3, 2, void 0, qe, $t) ?? 0,
          score: $e(e3, 4, void 0, qe, $t) ?? 0,
          label: le($e(e3, 3, void 0, qe)) ?? "",
        });
    return s2;
  }
  function Ho(t2) {
  ...
  async function Jo(t2, e2, n2) {
    return {
      wasmLoaderPath: `${e2}/${t2}_${(n2 = `wasm${n2 ? "_module" : ""}${(await $o(n2)) ? "" : "_nosimd"}_internal`)}.js`,
  ...
  function ca(t2, e2) {
    ...
    ("string" == typeof e2
      ? (Ze(n2, 2, ue(e2)), Ze(n2, 1))
      : e2 instanceof Uint8Array && (Ze(n2, 1, ht(e2, false)), Ze(n2, 2)),
      wn(t2.baseOptions, 0, 1, n2));
  }
  function ha(t2) {
    try {
  ...
  function la(t2, e2) {
    ((t2.B = new is()),
      Rn(t2.B, 2, "PassThroughCalculator"),
      ns(t2.B, "free_memory"),
      rs(t2.B, "free_memory_unused_out"),
      hs(e2, "free_memory"),
      cs(e2, t2.B));
  }
  function fa(t2, e2) {
      ...
      if (e2) {
        ...
        if (
          !(
            ...
            t2.baseOptions?.modelAssetBuffer ||
            t2.baseOptions?.modelAssetPath
          )
        )
          throw Error(
        ...
        if (
          ((function (t3, e4) {
            ...
            ("delegate" in e4 &&
              ("GPU" === e4.delegate
                ? ((e4 = n2), (r2 = new zi()), Tn(e4, 2, js, r2))
                : ((e4 = n2), (r2 = new $i()), Tn(e4, 4, js, r2))),
              wn(t3.baseOptions, 0, 3, n2));
          })(this, e3),
          e3.modelAssetPath)
        )
  ...
  function ya(t2, e2, n2) {
    const r2 = t2.g;
    if (
      ((n2 = ga(r2.createShader(n2), "Failed to create WebGL shader")),
  ...
  function _a(t2, e2) {
    const n2 = t2.g,
      r2 = ga(n2.createVertexArray(), "Failed to create vertex array");
  ...
  function Ea(t2, e2, n2, r2) {
    return (
      ...
      t2.h || (t2.m(), t2.D()),
      n2
        ? (t2.u || (t2.u = _a(t2, true)), (n2 = t2.u))
        : (t2.A || (t2.A = _a(t2, false)), (n2 = t2.A)),
      e2.useProgram(t2.h),
      n2.bind(),
      t2.l(),
      (t2 = r2()),
  ...
  function wa(t2, e2, n2) {
    return (
      va(t2, e2),
      (t2 = ga(e2.createTexture(), "Failed to create texture")),
  ...
  function Ta(t2, e2, n2) {
    (va(t2, e2),
      t2.B ||
        (t2.B = ga(e2.createFramebuffer(), "Failed to create framebuffe.")),
  ...
  var ba = class {
    ...
    m() {
      const t2 = this.g;
      if (
        ((this.h = ga(t2.createProgram(), "Failed to create WebGL program")),
        (this.X = ya(
          this,
          "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }",
          t2.VERTEX_SHADER,
        )),
        (this.W = ya(this, this.H(), t2.FRAGMENT_SHADER)),
  ...
  var ka = class extends ba {
    ...
    D() {
      ...
      (t2.activeTexture(t2.TEXTURE1),
        (this.C = wa(this, t2, t2.LINEAR)),
        t2.activeTexture(t2.TEXTURE2),
        (this.j = wa(this, t2, t2.NEAREST)));
    }
    m() {
      super.m();
      const t2 = this.g;
  ...
  function Pa(t2) {
    ...
    return (
      n2 ||
        ((n2 = wa(Ma(t2), e2, t2.m ? e2.LINEAR : e2.NEAREST)),
        t2.g.push(n2),
        (t2.j = true)),
        ...
        if (e2 instanceof Uint8Array) n2 = new Uint8Array(e2);
            ...
            throw Error(`Type is not supported: ${e2}`);
          {
            ...
            (t3.activeTexture(t3.TEXTURE1),
              (n2 = wa(e3, t3, this.m ? t3.LINEAR : t3.NEAREST)),
  ...
  var Ka = class {
    ...
    ya(t2, e2) {
      if (t2) {
        ...
        var r2 = n2.canvas,
          i2 = 0;
        for (const s2 of t2)
          ((n2.fillStyle = Ga(e2.fillColor, { index: i2, from: s2 })),
            (n2.strokeStyle = Ga(e2.color, { index: i2, from: s2 })),
            (n2.lineWidth = Ga(e2.lineWidth, { index: i2, from: s2 })),
            (t2 = new Path2D()).arc(
              s2.x * r2.width,
              s2.y * r2.height,
              Ga(e2.radius, { index: i2, from: s2 }),
              0,
              2 * Math.PI,
            ),
            n2.fill(t2),
    ...
    xa(t2, e2, n2) {
      if (t2 && e2) {
        ...
        for (const o2 of e2) {
          ...
          (e2 &&
            a2 &&
            ((r2.strokeStyle = Ga(n2.color, { index: s2, from: e2, to: a2 })),
            (r2.lineWidth = Ga(n2.lineWidth, { index: s2, from: e2, to: a2 })),
    ...
    ua(t2, e2) {
      ...
      ((e2 = Ba(e2)),
        n2.save(),
        n2.beginPath(),
        (n2.lineWidth = Ga(e2.lineWidth, {})),
        (n2.strokeStyle = Ga(e2.color, {})),
        (n2.fillStyle = Ga(e2.fillColor, {})),
  ...
  function Qa(t2) {
    ...
    let n2 = Ya(t2, 2);
    return (
      n2 || ((n2 = wa(Za(t2), e2)), t2.g.push(n2), (t2.m = true)),
      e2.bindTexture(e2.TEXTURE_2D, n2),
      n2
    );
  }
  ...
  ((Ka.prototype.close = Ka.prototype.close),
    ...
    (Ka.lerp = function (t2, e2, n2, r2, i2) {
      return ja(
  ...
  async function cc(t2, e2, n2) {
    return (async function (t3, e3, n3, r2) {
      ...
      t2,
      n2.canvas ?? (Qo() ? void 0 : document.createElement("canvas")),
      e2,
      n2,
    );
  }
  function hc(t2, e2, n2, r2) {
    if (t2.U) {
      ...
      if (n2?.regionOfInterest) {
        ...
        (Ln(s2, 1, (i2.left + i2.right) / 2),
          Ln(s2, 2, (i2.top + i2.bottom) / 2),
          Ln(s2, 4, i2.right - i2.left),
          Ln(s2, 3, i2.bottom - i2.top));
      ...
      if (n2?.rotationDegrees) {
        ...
        if (
          (Ln(s2, 5, (-Math.PI * n2.rotationDegrees) / 180),
          n2?.rotationDegrees % 180 != 0)
        ) {
          const [t3, r3] = ea(e2);
          ((n2 = (Sn(s2, 3) * r3) / t3),
            (i2 = (Sn(s2, 4) * t3) / r3),
  ...
  function fc(t2, e2, n2, r2) {
    ...
    return (
      (t2 = new Na([i2], n2, false, t2.g.i.canvas, t2.P, s2, e2)),
      r2 ? t2.clone() : t2
    );
  }
      ...
      if (
        ("runningMode" in t2 &&
          Ze(
            this.baseOptions,
            2,
            Jt(!!t2.runningMode && "IMAGE" !== t2.runningMode),
          ),
  ...
  var pc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "image_in", "norm_rect_in", false),
        (this.j = { detections: [] }),
        wn((t2 = this.h = new zs()), 0, 1, (e2 = new Xs())),
        Ln(this.h, 2, 0.5),
        Ln(this.h, 3, 0.3));
    }
    get baseOptions() {
    ...
    o(t2) {
      return (
        "minDetectionConfidence" in t2 &&
          Ln(this.h, 2, t2.minDetectionConfidence ?? 0.5),
        "minSuppressionThreshold" in t2 &&
          Ln(this.h, 3, t2.minSuppressionThreshold ?? 0.3),
        this.l(t2)
      );
    }
    F(t2, e2) {
    ...
    m() {
      ...
      xr(e2, Ys, this.h);
      const n2 = new is();
      (Rn(n2, 2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"),
        ns(n2, "IMAGE:image_in"),
        ns(n2, "NORM_RECT:norm_rect_in"),
        rs(n2, "DETECTIONS:detections"),
        n2.o(e2),
        cs(t2, n2),
  ...
  ((pc.prototype.detectForVideo = pc.prototype.G),
    ...
    (pc.createFromModelPath = async function (t2, e2) {
  ...
  var Sc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "image_in", "norm_rect", false),
        (this.j = {
          faceLandmarks: [],
          faceBlendshapes: [],
          facialTransformationMatrixes: [],
        ...
        (this.outputFacialTransformationMatrixes = this.outputFaceBlendshapes =
          false),
        wn((t2 = this.h = new Js()), 0, 1, (e2 = new Xs())),
        (this.A = new $s()),
    ...
    o(t2) {
      return (
        "numFaces" in t2 && xn(this.u, 4, t2.numFaces ?? 1),
        "minFaceDetectionConfidence" in t2 &&
          Ln(this.u, 2, t2.minFaceDetectionConfidence ?? 0.5),
        "minTrackingConfidence" in t2 &&
          Ln(this.h, 4, t2.minTrackingConfidence ?? 0.5),
        "minFacePresenceConfidence" in t2 &&
          Ln(this.A, 2, t2.minFacePresenceConfidence ?? 0.5),
    ...
    m() {
      ...
      xr(e2, Qs, this.h);
      const n2 = new is();
      (Rn(n2, 2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"),
        ns(n2, "IMAGE:image_in"),
        ns(n2, "NORM_RECT:norm_rect"),
        rs(n2, "NORM_LANDMARKS:face_landmarks"),
        n2.o(e2),
        cs(t2, n2),
        ...
        this.outputFacialTransformationMatrixes &&
          (us(t2, "face_geometry"),
          rs(n2, "FACE_GEOMETRY:face_geometry"),
  ...
  ((Sc.prototype.detectForVideo = Sc.prototype.G),
    ...
    (Sc.createFromModelPath = function (t2, e2) {
  ...
  function Ic(t2, e2 = true) {
    ...
    for (const i2 of t2) {
      ...
      for (const n3 of r2.g())
        ((r2 = e2 && null != kn(n3, 1) ? (kn(n3, 1) ?? 0) : -1),
          t2.push({
            score: Sn(n3, 2) ?? 0,
            index: r2,
            categoryName: le($e(n3, 3)) ?? "" ?? "",
            displayName: le($e(n3, 4)) ?? "" ?? "",
          }));
      n2.push(t2);
    }
    return n2;
  ...
  var Fc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "image_in", "norm_rect", false),
        ...
        (this.worldLandmarks = []),
        (this.handedness = []),
        wn((t2 = this.j = new oo()), 0, 1, (e2 = new Xs())),
        (this.u = new so()),
    ...
    o(t2) {
      if (
        (xn(this.A, 3, t2.numHands ?? 1),
        "minHandDetectionConfidence" in t2 &&
          Ln(this.A, 2, t2.minHandDetectionConfidence ?? 0.5),
        "minTrackingConfidence" in t2 &&
          Ln(this.u, 4, t2.minTrackingConfidence ?? 0.5),
        "minHandPresenceConfidence" in t2 &&
          Ln(this.D, 2, t2.minHandPresenceConfidence ?? 0.5),
        t2.cannedGesturesClassifierOptions)
      ) {
        var e2 = new to(),
          n2 = e2,
          r2 = Bo(t2.cannedGesturesClassifierOptions, yn(this.h, to, 3)?.l());
    ...
    m() {
      ...
      (hs(t2, "image_in"),
        hs(t2, "norm_rect"),
        us(t2, "hand_gestures"),
        us(t2, "hand_landmarks"),
        us(t2, "world_hand_landmarks"),
        us(t2, "handedness"));
      const e2 = new Qi();
      xr(e2, lo, this.j);
      const n2 = new is();
      (Rn(
        ...
        ns(n2, "IMAGE:image_in"),
        ns(n2, "NORM_RECT:norm_rect"),
        rs(n2, "HAND_GESTURES:hand_gestures"),
        rs(n2, "LANDMARKS:hand_landmarks"),
        rs(n2, "WORLD_LANDMARKS:world_hand_landmarks"),
        rs(n2, "HANDEDNESS:handedness"),
        n2.o(e2),
        cs(t2, n2),
  ...
  ((Fc.prototype.recognizeForVideo = Fc.prototype.Ia),
    ...
    (Fc.createFromModelPath = function (t2, e2) {
  ...
  var Pc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "image_in", "norm_rect", false),
        ...
        (this.worldLandmarks = []),
        (this.handedness = []),
        wn((t2 = this.h = new so()), 0, 1, (e2 = new Xs())),
        (this.u = new io()),
    ...
    o(t2) {
      return (
        "numHands" in t2 && xn(this.j, 3, t2.numHands ?? 1),
        "minHandDetectionConfidence" in t2 &&
          Ln(this.j, 2, t2.minHandDetectionConfidence ?? 0.5),
        "minTrackingConfidence" in t2 &&
          Ln(this.h, 4, t2.minTrackingConfidence ?? 0.5),
        "minHandPresenceConfidence" in t2 &&
          Ln(this.u, 2, t2.minHandPresenceConfidence ?? 0.5),
        this.l(t2)
      );
    }
    F(t2, e2) {
    ...
    m() {
      ...
      xr(e2, fo, this.h);
      const n2 = new is();
      (Rn(n2, 2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"),
        ns(n2, "IMAGE:image_in"),
        ns(n2, "NORM_RECT:norm_rect"),
        rs(n2, "LANDMARKS:hand_landmarks"),
        rs(n2, "WORLD_LANDMARKS:world_hand_landmarks"),
          ...
          for (const e4 of t3) {
            ...
            for (const e5 of t3.g())
              n4.push({
                score: Sn(e5, 2) ?? 0,
                index: kn(e5, 1) ?? 0 ?? -1,
                categoryName: le($e(e5, 3)) ?? "" ?? "",
                displayName: le($e(e5, 4)) ?? "" ?? "",
              });
            i2.push(n4);
          }
  ...
  ((Pc.prototype.detectForVideo = Pc.prototype.G),
    (Pc.prototype.detect = Pc.prototype.F),
    (Pc.prototype.setOptions = Pc.prototype.o),
    (Pc.createFromModelPath = function (t2, e2) {
      return cc(Pc, t2, { baseOptions: { modelAssetPath: e2 } });
    }),
    (Pc.createFromModelBuffer = function (t2, e2) {
      return cc(Pc, t2, { baseOptions: { modelAssetBuffer: e2 } });
  ...
  var Dc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "input_frames_image", null, false),
        (this.h = {
          faceLandmarks: [],
          faceBlendshapes: [],
          poseLandmarks: [],
        ...
        wn((t2 = this.j = new yo()), 0, 1, (e2 = new Xs())),
        (this.I = new io()),
    ...
    o(t2) {
      return (
        ...
        "minFaceSuppressionThreshold" in t2 &&
          Ln(this.u, 3, t2.minFaceSuppressionThreshold ?? 0.3),
        "minFacePresenceConfidence" in t2 &&
          Ln(this.O, 2, t2.minFacePresenceConfidence ?? 0.5),
        "outputFaceBlendshapes" in t2 &&
          (this.outputFaceBlendshapes = !!t2.outputFaceBlendshapes),
        "minPoseDetectionConfidence" in t2 &&
          Ln(this.A, 2, t2.minPoseDetectionConfidence ?? 0.5),
        "minPoseSuppressionThreshold" in t2 &&
          Ln(this.A, 3, t2.minPoseSuppressionThreshold ?? 0.3),
        "minPosePresenceConfidence" in t2 &&
          Ln(this.M, 2, t2.minPosePresenceConfidence ?? 0.5),
        ...
        "minHandLandmarksConfidence" in t2 &&
          Ln(this.I, 2, t2.minHandLandmarksConfidence ?? 0.5),
        this.l(t2)
      );
    }
    F(t2, e2, n2) {
    ...
    m() {
      var t2 = new ls();
      (hs(t2, "input_frames_image"),
        us(t2, "pose_landmarks"),
        us(t2, "pose_world_landmarks"),
        us(t2, "face_landmarks"),
        us(t2, "left_hand_landmarks"),
        us(t2, "left_hand_world_landmarks"),
        us(t2, "right_hand_landmarks"),
        us(t2, "right_hand_world_landmarks"));
      const e2 = new Qi(),
        n2 = new Bi();
      (Rn(
        n2,
        ...
        (function (t3, e3) {
          if (null != e3)
            if (Array.isArray(e3)) Ze(t3, 2, Ie(e3, 0, Me));
            else {
      ...
      (Rn(
        ...
        bn(r2, 8, Bi, n2),
        ns(r2, "IMAGE:input_frames_image"),
        rs(r2, "POSE_LANDMARKS:pose_landmarks"),
        rs(r2, "POSE_WORLD_LANDMARKS:pose_world_landmarks"),
        rs(r2, "FACE_LANDMARKS:face_landmarks"),
        rs(r2, "LEFT_HAND_LANDMARKS:left_hand_landmarks"),
        rs(r2, "LEFT_HAND_WORLD_LANDMARKS:left_hand_world_landmarks"),
        rs(r2, "RIGHT_HAND_LANDMARKS:right_hand_landmarks"),
        rs(r2, "RIGHT_HAND_WORLD_LANDMARKS:right_hand_world_landmarks"),
        r2.o(e2),
        cs(t2, r2),
        la(this, t2),
        ...
        this.outputPoseSegmentationMasks &&
          (rs(r2, "POSE_SEGMENTATION_MASK:pose_segmentation_mask"),
          fa(this, "pose_segmentation_mask"),
          this.g.Z("pose_segmentation_mask", (t3, e3) => {
            ((this.h.poseSegmentationMasks = [fc(this, t3, true, !this.D)]),
              ua(this, e3));
          }),
        ...
        this.outputFaceBlendshapes &&
          (us(t2, "extra_blendshapes"),
          rs(r2, "FACE_BLENDSHAPES:extra_blendshapes"),
          this.g.attachProtoListener("extra_blendshapes", (t3, e3) => {
            var n3 = this.h.faceBlendshapes;
            (this.outputFaceBlendshapes &&
              ((t3 = ys(t3)), n3.push(jo(t3.g() ?? []))),
              ua(this, e3));
          }),
  ...
  ((Dc.prototype.detectForVideo = Dc.prototype.G),
    ...
    (Dc.createFromModelPath = function (t2, e2) {
  ...
  var Bc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "input_image", "norm_rect", true),
        (this.j = { classifications: [] }),
        wn((t2 = this.h = new Eo()), 0, 1, (e2 = new Xs())));
    }
    get baseOptions() {
      return yn(this.h, Xs, 1);
    }
    ...
    m() {
      ...
      (Rn(
        ...
        ns(n2, "IMAGE:input_image"),
        ns(n2, "NORM_RECT:norm_rect"),
        rs(n2, "CLASSIFICATIONS:classifications"),
        n2.o(e2),
        cs(t2, n2),
  ...
  ((Bc.prototype.classifyForVideo = Bc.prototype.ta),
    ...
    (Bc.createFromModelPath = function (t2, e2) {
  ...
  var Gc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "image_in", "norm_rect", true),
        (this.h = new To()),
        (this.embeddings = { embeddings: [] }),
        wn((t2 = this.h), 0, 1, (e2 = new Xs())));
    }
    get baseOptions() {
      return yn(this.h, Xs, 1);
    }
    ...
    o(t2) {
      var e2 = this.h,
        n2 = yn(this.h, Ds, 2);
      return (
        (n2 = n2 ? n2.clone() : new Ds()),
        void 0 !== t2.l2Normalize
          ? Ze(n2, 1, Jt(t2.l2Normalize))
          : "l2Normalize" in t2 && Ze(n2, 1),
        void 0 !== t2.quantize
          ? Ze(n2, 2, Jt(t2.quantize))
          : "quantize" in t2 && Ze(n2, 2),
        wn(e2, 0, 2, n2),
        this.l(t2)
      );
    }
    ...
    m() {
      ...
      xr(e2, Ao, this.h);
      const n2 = new is();
      (Rn(n2, 2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"),
        ns(n2, "IMAGE:image_in"),
        ns(n2, "NORM_RECT:norm_rect"),
        rs(n2, "EMBEDDINGS:embeddings_out"),
        n2.o(e2),
        cs(t2, n2),
        this.g.attachProtoListener("embeddings_out", (t3, e3) => {
          ((t3 = Os(t3)),
            (this.embeddings = (function (t4) {
              return {
                embeddings: vn(t4, Ps, 1).map((t5) => {
                  const e4 = {
                    headIndex: kn(t5, 3) ?? 0 ?? -1,
                    headName: le($e(t5, 4)) ?? "" ?? "",
                  };
                  var n3 = t5.v;
                  return (
                    void 0 !== mn(n3, 0 | n3[Q], Fs, ln(t5, 1))
                      ? ((t5 = en(
                          (t5 = yn(t5, Fs, ln(t5, 1), void 0)),
                          1,
                          $t,
                          tn(),
                        )),
  ...
  ((Gc.cosineSimilarity = function (t2, e2) {
    ...
    (Gc.createFromModelPath = function (t2, e2) {
  ...
  function Vc(t2) {
    ...
    1 === e2.length &&
      (yn(e2[0], Qi, 7)?.j()?.g() ?? /* @__PURE__ */ new Map()).forEach(
        (e3, n2) => {
  ...
  var Wc = class extends dc {
    ...
    o(t2) {
      return (
        void 0 !== t2.displayNamesLocale
          ? Ze(this.h, 2, ue(t2.displayNamesLocale))
          : "displayNamesLocale" in t2 && Ze(this.h, 2),
    ...
    m() {
      ...
      xr(e2, Ro, this.h);
      const n2 = new is();
      (Rn(n2, 2, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"),
        ns(n2, "IMAGE:image_in"),
        ns(n2, "NORM_RECT:norm_rect"),
        n2.o(e2),
        cs(t2, n2),
        ...
        this.outputCategoryMask &&
          (us(t2, "category_mask"),
          rs(n2, "CATEGORY_MASK:category_mask"),
        ...
        us(t2, "quality_scores"),
        rs(n2, "QUALITY_SCORES:quality_scores"),
  ...
  ((Wc.prototype.getLabels = Wc.prototype.Da),
    ...
    (Wc.createFromModelPath = function (t2, e2) {
  ...
  var Kc = class extends dc {
    ...
    segment(t2, e2, n2, r2) {
      ...
      if (e2.keypoint) {
        var s2 = new Io();
        (hn(s2, 3, Jt(true), false),
          hn(s2, 1, qt(e2.keypoint.x), 0),
          hn(s2, 2, qt(e2.keypoint.y), 0),
          Tn(r2, 1, Co, s2));
      } else {
        if (!e2.scribble)
  ...
  ((Kc.prototype.segment = Kc.prototype.segment),
    ...
    (Kc.createFromModelPath = function (t2, e2) {
  ...
  var Yc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "input_frame_gpu", "norm_rect", false),
        (this.j = { detections: [] }),
        wn((t2 = this.h = new Oo()), 0, 1, (e2 = new Xs())));
    }
    get baseOptions() {
      return yn(this.h, Xs, 1);
    }
    ...
    o(t2) {
      return (
        void 0 !== t2.displayNamesLocale
          ...
          : "displayNamesLocale" in t2 && Ze(this.h, 2),
        void 0 !== t2.maxResults
          ? xn(this.h, 3, t2.maxResults)
          : "maxResults" in t2 && Ze(this.h, 3),
        void 0 !== t2.scoreThreshold
          ? Ln(this.h, 4, t2.scoreThreshold)
          : "scoreThreshold" in t2 && Ze(this.h, 4),
        void 0 !== t2.categoryAllowlist
          ? In(this.h, 5, t2.categoryAllowlist)
          : "categoryAllowlist" in t2 && Ze(this.h, 5),
        void 0 !== t2.categoryDenylist
          ? In(this.h, 6, t2.categoryDenylist)
          : "categoryDenylist" in t2 && Ze(this.h, 6),
        this.l(t2)
      );
    }
    F(t2, e2) {
    ...
    m() {
      ...
      xr(e2, No, this.h);
      const n2 = new is();
      (Rn(n2, 2, "mediapipe.tasks.vision.ObjectDetectorGraph"),
        ns(n2, "IMAGE:input_frame_gpu"),
        ns(n2, "NORM_RECT:norm_rect"),
        rs(n2, "DETECTIONS:detections"),
        n2.o(e2),
        cs(t2, n2),
  ...
  ((Yc.prototype.detectForVideo = Yc.prototype.G),
    ...
    (Yc.createFromModelPath = async function (t2, e2) {
  ...
  var Zc = class extends dc {
    constructor(t2, e2) {
      (super(new ac(t2, e2), "image_in", "norm_rect", false),
        ...
        wn((t2 = this.h = new Uo()), 0, 1, (e2 = new Xs())),
        (this.A = new mo()),
        wn(this.h, 0, 3, this.A),
        (this.j = new go()),
        wn(this.h, 0, 2, this.j),
    ...
    o(t2) {
      return (
        "numPoses" in t2 && xn(this.j, 4, t2.numPoses ?? 1),
        "minPoseDetectionConfidence" in t2 &&
          Ln(this.j, 2, t2.minPoseDetectionConfidence ?? 0.5),
        "minTrackingConfidence" in t2 &&
          Ln(this.h, 4, t2.minTrackingConfidence ?? 0.5),
        "minPosePresenceConfidence" in t2 &&
          Ln(this.A, 2, t2.minPosePresenceConfidence ?? 0.5),
    ...
    m() {
      ...
      (hs(t2, "image_in"),
        hs(t2, "norm_rect"),
        us(t2, "normalized_landmarks"),
        us(t2, "world_landmarks"),
        us(t2, "segmentation_masks"));
      const e2 = new Qi();
      xr(e2, Do, this.h);
      const n2 = new is();
      (Rn(n2, 2, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
        ns(n2, "IMAGE:image_in"),
        ns(n2, "NORM_RECT:norm_rect"),
        rs(n2, "NORM_LANDMARKS:normalized_landmarks"),
        rs(n2, "WORLD_LANDMARKS:world_landmarks"),
        n2.o(e2),
        cs(t2, n2),
        la(this, t2),
  ...
  ((Zc.prototype.detectForVideo = Zc.prototype.G),
    ...
    (Zc.createFromModelPath = function (t2, e2) {
  ...
  self.addEventListener("message", async (event) => {
    ...
    if (type === "detectSmart") {
      ...
      for (let bi2 = 0; bi2 < buckets.length; bi2++) {
        ...
        const find = (x2) =>
          parent[x2] === x2 ? x2 : (parent[x2] = find(parent[x2]));
        const union = (a2, b2) => {
